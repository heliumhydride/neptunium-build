...
info "building host-libsodium"
build_host_libsodium > "$LOG_FILE"
info "installing host-libsodium"
install_host_libsodium > "$LOG_FILE"
...
info "building libsodium"
build_libsodium > "$LOG_FILE"
